...
func RunningSpentCalories(action int, weight, duration float64) float64 {
	...
	answer = ((runningCaloriesMeanSpeedMultiplier * speed * runningCaloriesMeanSpeedShift) * weight / mInKm * duration * minInH)
	return answer
}
...
func WalkingSpentCalories(action int, duration, weight, height float64) float64 {
	...
	answer = ((walkingCaloriesWeightMultiplier*weight + (math.Pow(speed, 2)/(height/100))*walkingSpeedHeightMultiplier*weight) * duration * minInH)
	return answer
}
...
func SwimmingSpentCalories(lengthPool, countPool int, duration, weight float64) float64 {
	...
	answer = (speed + swimmingCaloriesMeanSpeedShift) * swimmingCaloriesWeightMultiplier * weight * duration
	return answer
}
